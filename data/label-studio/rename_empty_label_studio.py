...
if not os.path.exists('Annotations_uu'):
    os.makedirs('Annotations_uu')
...
annotation_files = [os.path.splitext(filename)[0] for filename in os.listdir('Annotations_uu')]
